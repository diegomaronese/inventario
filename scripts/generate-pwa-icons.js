...
// Standard icon SVG (512x512 with rounded squircle)
const iconSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
  <defs>
    ...
    <linearGradient id="laserBeam" x1="0%" y1="0%" x2="100%" y2="0%">
      ...
      <stop offset="75%" stop-color="#fef08a" stop-opacity="0.9"/>
  ...
  <!-- Outer subtle metallic border -->
  <rect x="8" y="8" width="496" height="496" rx="104" fill="none" stroke="url(#amberGrad)" stroke-width="3.5" opacity="0.45"/>
  <rect x="14" y="14" width="484" height="484" rx="98" fill="none" stroke="#ffffff" stroke-width="1" opacity="0.08"/>

  <!-- Central Asset Card / Tablet Frame -->
  <g transform="translate(106, 88)">
    <!-- Shadow behind card -->
    <rect x="0" y="8" width="300" height="340" rx="36" fill="#000000" opacity="0.6"/>

    <!-- Main Card Body -->
    <rect x="0" y="0" width="300" height="340" rx="36" fill="url(#cardGrad)" stroke="#3f3f46" stroke-width="2.5"/>
    ...
    <rect x="36" y="100" width="228" height="150" rx="20" fill="#09090b" stroke="#27272a" stroke-width="2"/>

    <!-- Barcode Vertical Stripes in Gold/White -->
    <g fill="url(#goldLight)" transform="translate(56, 118)">
    ...
    <!-- Subtle ID numeric subtitle under barcode -->
    <text x="150" y="232" fill="#a1a1aa" font-family="'Roboto Mono', monospace, sans-serif" font-size="13" font-weight="700" letter-spacing="4" text-anchor="middle">2026 • APUCARANA</text>

    <!-- Lower Status Bar Details -->
    <rect x="36" y="272" width="150" height="18" rx="9" fill="#27272a"/>
    <rect x="36" y="298" width="90" height="12" rx="6" fill="#27272a" opacity="0.6"/>
  </g>

  <!-- Green & Gold Verification Seal (Bottom-Right Badge) -->
  <g transform="translate(320, 320)">
    <!-- Shadow -->
    <circle cx="56" cy="58" r="50" fill="#000000" opacity="0.5"/>
    <!-- Outer Gold Ring -->
...
const maskableSvg = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="512" height="512">
  <defs>
    ...
    <linearGradient id="mGoldLight" x1="0%" y1="0%" x2="0%" y2="100%">
      <stop offset="0%" stop-color="#fef08a"/>
      <stop offset="100%" stop-color="#f59e0b"/>
    </linearGradient>
    ...
    <radialGradient id="mAmbientGlow" cx="50%" cy="35%" r="60%">
      <stop offset="0%" stop-color="#f59e0b" stop-opacity="0.3"/>
      <stop offset="60%" stop-color="#f59e0b" stop-opacity="0.03"/>
      <stop offset="100%" stop-color="#000000" stop-opacity="0"/>
    </radialGradient>
  ...
  <!-- Full-bleed background for maskable format -->
  ...
  <g transform="translate(256, 256) scale(0.78) translate(-256, -256)">
    ...
    <g transform="translate(106, 92)">
      <rect x="0" y="8" width="300" height="336" rx="36" fill="#000000" opacity="0.6"/>
      <rect x="0" y="0" width="300" height="336" rx="36" fill="url(#mCardGrad)" stroke="#3f3f46" stroke-width="2.5"/>
      ...
      <!-- Barcode Container Area -->
      <rect x="36" y="98" width="228" height="148" rx="20" fill="#09090b" stroke="#27272a" stroke-width="2"/>

      <!-- Barcode Vertical Stripes -->
      <g fill="url(#mGoldLight)" transform="translate(56, 116)">
      ...
      <text x="150" y="228" fill="#a1a1aa" font-family="'Roboto Mono', monospace, sans-serif" font-size="13" font-weight="700" letter-spacing="4" text-anchor="middle">2026 • APUCARANA</text>

      <rect x="36" y="268" width="140" height="18" rx="9" fill="#27272a"/>
      <rect x="36" y="294" width="80" height="12" rx="6" fill="#27272a" opacity="0.6"/>
    </g>

    <!-- Green & Gold Verification Seal -->
    <g transform="translate(316, 316)">
      <circle cx="56" cy="58" r="48" fill="#000000" opacity="0.5"/>
